...
일반 배열 [] : Arrays.sort(arr, 0, n); // Integer[] arr = new Integer[n+1];

컬랙션 배열 : **Collections.sort(arr.subList(0, n));** // List<Integer> arr = new ArrayList<>(); , arr.add(val);

일반 배열 []도 **래퍼(Integer 등) 타입으로 정의되었다면**,
