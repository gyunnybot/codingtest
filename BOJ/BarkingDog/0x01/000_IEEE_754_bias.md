...
## 6. 알아두면 좋은 공식
- **10진수 실수를 2진수로 바꾸는 공식**
10진수 실수를 2진수로 바꿀 때는 정수부와 소수부를 따로 계산 후 합칩니다.

예를 들어 10진수 실수 -6.25에서 정수부 6는 110(2)로 나타낼 수 있습니다.

이후 남은 소수부 0.25가 정수 1이 될 때까지 2를 곱한 값의 정수부만을 아래서부터 차례로 저장한 후 연산값에서 뺍니다.

예를 들어 5.75의 경우 소수부는 0.75이고
0.25 x 2 = 0.5 -> 0
0.5 x 2 = 1 -> 1

10진수 실수 -6.25는 2진수 -110.01로 나타낼 수 있습니다.

bias 계산을 위해서는 정수부를 한자릿수로 변경해야 합니다. 따라서, 최종 변환 값은 -1.1001 x 2^2가 됩니다.

- **bias = 2^(자료형에 따른 지수부의 최대 비트 - 1) - 1**
