...
/*
1. a ^ b = c라면 a ^ c = b, b ^ c = a이 성립한다

2. XOR 연산에서 0은 상대 비트를 따라가고, 1은 비트를 반전시키므로 b = 1, 2, 4, 8... 탐색 방식은 자연스럽다

예를 들어 초기 비밀번호가 3이고 b = 1, 2, 4, 8이라면 XOR 연산 값은 2, 1, 7, 11이 반환되는데,
1번 명제를 통해 3 ^ (2, 1, 7, 11) = (1, 2, 4, 8)이므로 3과 안전거리가 1인 수의 집합은 2, 1, 7, 11임을 알 수 있다
